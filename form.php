                ...
                <div class="my-2">
                  ...
                  <div class="my-2 jumbotron p-1 <?php if ($errors['SP']) {print 'class="error"';} ?>">
                      <div class="form-group" value="">
                        ...
                        <option <?php for ($i=0;$i<count($values, COUNT_RECURSIVE)-8;$i++) if ($values['SP'][$i]=='Time freeze') print 'selected=""' ?>>Time freeze</option>
                        <option <?php for ($i=0;$i<count($values, COUNT_RECURSIVE)-8;$i++) if ($values['SP'][$i]=='Teleportation') print 'selected=""' ?>>Teleportation</option>
                        <option <?php for ($i=0;$i<count($values, COUNT_RECURSIVE)-8;$i++) if ($values['SP'][$i]=='Absolute knowledge') print 'selected=""' ?>>Absolute knowledge</option>
                        <option <?php for ($i=0;$i<count($values, COUNT_RECURSIVE)-8;$i++) if ($values['SP'][$i]=='Fundamental immortality') print 'selected=""' ?>>Fundamental immortality</option>
                      </select>
                    </div>
                  </div>
                  <div class="my-2">
